<template>
  <div class="w-full flex justify-between">
    ...
    />
    <n-button type="error" ghost @click="handleReset">重置配置</n-button>
    <div class="domRef" data-clipboard-target="#themeConfigCopyTarget">
      <n-button type="primary">复制配置</n-button>
    </div>
  </div>
</template>
