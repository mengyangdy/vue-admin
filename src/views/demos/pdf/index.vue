<template>
  <div class="overflow-hidden">
    <NCard title="PDF预览" :bordered="false" class="h-full card-wrapper">
      <div class="h-full flex-col-stretch">
        ...
        <div class="flex-y-center justity-between">
          <div v-if="showAllPages" class="text-18px font-medium">总页数：{{ pageCount }}</div>
