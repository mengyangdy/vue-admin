<template>
  <div>
    <NCard title="pinyin插件" :bordered="false" class="h-full card-wrapper">
      <NSpace :vertical="true">
        <GithubLink link="https://github.com/zh-lx/pinyin/pinyin-pro" />
...
function renderHtml() {
  ...
  const text = 'DylanAdmin是一个清新优雅、高颜值且功能强大的后台管理模板';
