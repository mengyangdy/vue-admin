...
export default defineComponent({
  ...
  setup(props) {
    ...
    const fullContentLayoutVars = useFullContentLayoutVars(
  ...
  render() {
      ...
      return (
        <div
          class={[
            ...
            {
              [`${this.mergedClsPrefix}-pro-layout__logo--hidden`]:
                !this.mergedLogo.show,
            },
    ...
    const navLeftDom = resolveWrappedSlot(
      this.$slots["nav-left"],
      (children) => {
        return (
    ...
    const navCenterDom = resolveWrappedSlot(
      this.$slots["nav-center"],
      (children) => {
        return (
    ...
    const navRightDom = resolveWrappedSlot(
    ...
    const sidebarDom = resolveWrappedSlot(this.$slots.sidebar, (children) => {
      ...
      return (
        <div class={`${this.mergedClsPrefix}-pro-layout__sidebar`}>
          {children}
        </div>
      );
    });

    const sidebarExtraDom = resolveWrappedSlot(
      this.$slots["sidebar-extra"],
      (children) => {
        if (!children) {
          return null;
        }
    ...
    return (
      <div
        ...
        class={[
          ...
          {
            [`${this.mergedClsPrefix}-pro-layout--disabled-transition`]:
              this.disabled,
          },
          {
      ...
      >
        <aside
          class={[
            ...
            {
              [`${this.mergedClsPrefix}-pro-layout__aside--collapsed`]:
                this.mergedCollapsed,
            },
            {
              [`${this.mergedClsPrefix}-pro-layout__aside--hidden`]:
                !this.mergedSidebar.show,
            },
        ...
        >
          ...
          >
            <div
              class={[
                ...
                {
                  [`${this.mergedClsPrefix}-pro-layout__nav--hidden`]:
                    !this.mergedNav.show,
                },
                ...this.mergedNavClass,
              ]}
            ...
            <div
              class={[
                ...
                {
                  [`${this.mergedClsPrefix}-pro-layout__tabbar--hidden`]:
                    !this.mergedTabbar.show,
                },
          ...
          <footer
            class={[
              ...
              {
                [`${this.mergedClsPrefix}-pro-layout__footer--fixed`]:
                  this.mergedFooter.fixed,
              },
              {
                [`${this.mergedClsPrefix}-pro-layout__footer--hidden`]:
                  !this.mergedFooter.show,
              },
